...
class CplusplusProgramlamaDili : AppCompatActivity() {
    @SuppressLint("MissingInflatedId")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_cplusplus_programlama_dili)
        ...
        Geri.setOnClickListener() {
            ...
            programlamaGiris.setOnClickListener(){
                var intent = Intent(this,ProgramlamayaGiris::class.java)
                startActivity(intent)
            }
            degiskenler.setOnClickListener(){
                var intent = Intent(this,DegiskenlerVeriTurleri::class.java)
                startActivity(intent)
            }
            operatörler.setOnClickListener(){
                var intent = Intent(this,Operatorler::class.java)
                startActivity(intent)
            }
            kontrolYapilari.setOnClickListener(){
                var intent = Intent(this,KontrolYapilari::class.java)
                startActivity(intent)
            }
            fonksiyonlar.setOnClickListener(){
                var intent = Intent(this,Fonksiyonlar::class.java)
                startActivity(intent)
            }
            diziler.setOnClickListener(){
                var intent = Intent(this,Diziler::class.java)
                startActivity(intent)
            }
            oop.setOnClickListener(){
                var intent = Intent(this,Oop::class.java)
                startActivity(intent)
            }
            hataYönetimi.setOnClickListener(){
                var intent = Intent(this,HataYonetimi::class.java)
                startActivity(intent)
            }
            dosyaIslem.setOnClickListener (){
                var intent = Intent(this,DosyaIslemleri::class.java)
                startActivity(intent)
            }
            veriTabani.setOnClickListener (){
                var intent = Intent(this,VeriTabani::class.java)
                startActivity(intent)
            }
